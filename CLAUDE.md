...
- **Auto-Update dieser Datei**: Claude soll diese CLAUDE.md-Datei alle 10 Minuten eigenständig aktualisieren und den aktuellen Projektstand, neue Erkenntnisse oder Änderungen eintragen.
